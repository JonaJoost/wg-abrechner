...
/**
 * Repräsentiert eine einzelne finanzielle Transaktion innerhalb der WG.
 * Eine Transaktion erfasst Details wie Datum, Betrag, wer gezahlt hat,
 * wer Begünstigter ist und eine Beschreibung.
 * <p>
 * Die Klasse ist {@link Serializable} für die Datenpersistenz
 * und {@link Comparable} für die Standard-Sortierung nach Datum (chronologisch).
 * </p>
 * @author Jona
 * @version 1.0
 * @since 2024-07-08
...
public class Transaction implements Serializable, Comparable<Transaction> {
     ...
     * @param amount        Der Betrag der Transaktion. Muss größer als 0 sein (wird im Ledger geprüft).
     * @param payer         Das {@link Member}-Objekt, das die Ausgabe getätigt hat. Muss nicht null sein.
     ...
     * @throws IllegalArgumentException Wenn Datum, Zahler, Begünstigte null sind oder die Begünstigtenliste leer ist.
     */
    public Transaction(LocalDate date, double amount, Member payer, List<Member> beneficiaries, String description) {
        if (date == null || payer == null || beneficiaries == null || beneficiaries.isEmpty()) {
            throw new IllegalArgumentException("Ungültige Transaktionsdaten: Datum, Zahler und Begünstigte dürfen nicht null sein und Begünstigtenliste darf nicht leer sein.");
        }
        this.date = date;
        this.amount = amount;
        this.payer = payer;
     ...
     * Dies ermöglicht das Sortieren von Transaktionen chronologisch.
     *
     ...
     * früher, am gleichen Datum oder später als die angegebene Transaktion stattfand.
     */
    @Override
